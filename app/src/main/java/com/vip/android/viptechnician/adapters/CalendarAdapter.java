...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (day_string.get(position).equals(curentDateString)) {
            ...
            v.setBackgroundResource(R.drawable.rounded_red_item);
    ...
    public View setSelected(View view, int pos, String selectedGridDate) {
        if (previousView != null) {
            previousView.setBackgroundColor(Color.WHITE);
        }

        if(!selectedGridDate.equals(curentDateString)){
    ...
    public void getPositionList(String date, final Activity act, View v, int position){
