package com.vip.android.viptechnician.appupdater;
...
import com.vip.android.viptechnician.appupdater.enums.AppUpdaterError;
import com.vip.android.viptechnician.appupdater.enums.Display;
import com.vip.android.viptechnician.appupdater.enums.Duration;
import com.vip.android.viptechnician.appupdater.enums.UpdateFrom;
import com.vip.android.viptechnician.appupdater.objects.GitHub;
import com.vip.android.viptechnician.appupdater.objects.Update;
                    ...
                    if (UtilsLibrary.isAbleToShow(successfulChecks, showEvery)) {
                        switch (display) {
                            case DIALOG:
                                ...
                                alertDialog = UtilsDisplay.showUpdateAvailableDialog(context, titleUpdate, getDescriptionUpdate(context, update, Display.DIALOG) /*btnDismiss*/, btnUpdate, btnDisable, updateClickListener, disableClickListener);
